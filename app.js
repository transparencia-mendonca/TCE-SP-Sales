...
const DBN="tcesp-sales-v6",STORE="dados",KEY="base";
...
function tceExpenseUrl(year){return `https://transparencia.tce.sp.gov.br/municipio/sales/${year}/despesas`}
